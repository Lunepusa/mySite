      ...
      <div>
        ...
        <Collapse trigger={<h3>✉️ Pay-Per-Message ~ $1 per my reply ✉️⏬</h3>}>
          <div>
            ...
            >
              ~ Dont want to commit to a larger price tag, but still want to ask
              some questions or chat? this is the option for you!
              <br />
              Extremely casual no media messaging, responding when I have time.
            </p>
